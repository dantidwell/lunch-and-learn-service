...
echo "Version: ${GO_PIPELINE_COUNTER}" >> "${PACKAGE_ROOT}/DEBIAN/control"
echo "Section: base" >> "${PACKAGE_ROOT}/DEBIAN/control"
echo "Priority: optional" >> "${PACKAGE_ROOT}/DEBIAN/control"
echo "Architecture: x64" >> "${PACKAGE_ROOT}/DEBIAN/control"
...
dpkg-deb --build "lunch-and-learn-api_${GO_PIPELINE_COUNTER}"
popd
